...
public class AdminMenu extends java_1206.movie.AbstractMenu {
    ...
    public Menu next() {
        switch (scanner.nextLine()) {
            ...
            try{
                java_1206.movie.Movie.delete(scanner.nextLine());
            }catch(IOException e){
         ...
         private void  printAllMovies(){
            try {
                ArrayList<java_1206.movie.Movie> movies = java_1206.movie.Movie.findAll();
                System.out.println();
            ...
            String genre = scanner.nextLine();
                java_1206.movie.Movie movie = new java_1206.movie.Movie(title, genre); //영화아이디는 자동생성
             try{
                    movie.save();
                }catch(IOException e){
